...
def generate_tcl(run, simulator, tb_model_list, srclist, inclist, log_name, tcl):
...
if __name__ == "__main__":
	...
	generate_tcl(int(sys.argv[1]), sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6], sys.argv[7]);
